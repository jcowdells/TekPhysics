...
exception bitsetSet2D(BitSet* bitset, uint x, uint y);
exception bitsetUnset2D(BitSet* bitset, uint x, uint y);
exception bitsetGet2D(const BitSet* bitset, uint x, uint y, flag* value);
